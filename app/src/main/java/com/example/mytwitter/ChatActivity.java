...
public class ChatActivity extends AppCompatActivity {
    ...
    private void SendMessage() {
        ...
        if (TextUtils.isEmpty(messageText)) {
            ...
            DatabaseReference user_message_key = RootRef.child("Messages").child(messageSenderID).child(messageReceiverID).push();//here it was double messageSenderID back to back,I eliminated one
